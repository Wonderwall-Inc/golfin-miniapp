...
const DemoDailyRewardComponent = ({
    ...
    return (
        <div className={`h-[100px] cursor-pointer`}
            aria-disabled={activity?.logged_in == false} // reward still not claimed?
            ...
            <div className='text-center w-[100%] h-[80px]'>
                ...
                ${activity?.logged_in == false ? "[background:linear-gradient(180deg,rgb(169,231,29)_0%,rgb(94.04,196.56,89.27)_100%)]" :
                        "[background:radial-gradient(50%_50%_at_50%_50%,rgb(112.62,108.57,77.9)_0%,rgb(119,102.27,78.84)_100%)]"}`}>
                    {activity?.logged_in == false ? <div className="absolute w-[77px] top-[7px] left-[40px] [font-family:'Roboto-Medium',Helvetica] font-medium text-[#ffffff] text-xl text-center tracking-[0] leading-[22px]">
                        Daily
                        <br />
                        Reward
                    </div> :
