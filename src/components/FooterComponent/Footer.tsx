                    ...
                    return (
                        <div key={index} className='link'>
                            <Link to={nav.url}>
                                ...
                                {nav.label == 'Demo Dev' && <ProfileIcon color={`${location.pathname == nav.url ? '#8ADD5D' : 'white'}`} />}
                                {nav.label == 'Demo Wallet' && <ProfileIcon color={`${location.pathname == nav.url ? '#8ADD5D' : 'white'}`} />}
                            </Link>
                        </div>
                    )
                })}
